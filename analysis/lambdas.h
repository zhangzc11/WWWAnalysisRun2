...
namespace Lambdas
{
    ...
    // Split by channel
    extern std::function<float()> isSRSSChannel;
    ...
    std::function<float()> SSKinSelNoMTmax(        Variation::ExpSyst expsyst=Variation::JES, Variation::Var var=Variation::Nominal);
    std::function<float()> SSKinSelNoMET(        Variation::ExpSyst expsyst=Variation::JES, Variation::Var var=Variation::Nominal);
    ...
    std::function<float()> SS1JPreselectionNoNb(Variation::ExpSyst expsyst=Variation::JES, Variation::Var var=Variation::Nominal, bool invert_btag=false);
    ...
    std::function<float()> SS1JNoMTmax(            Variation::ExpSyst expsyst=Variation::JES, Variation::Var var=Variation::Nominal);
    std::function<float()> SS1JNoMET(            Variation::ExpSyst expsyst=Variation::JES, Variation::Var var=Variation::Nominal);
    ...
    std::function<float()> CutCRTTbarDilep( Variation::ExpSyst expsyst=Variation::JES, Variation::Var var=Variation::Nominal);

    extern std::function<float()> SRDilepCutBDT2J;
    ...
    extern std::function<float()> SRDilepCutBDT1J;
    ...
    extern std::function<float()> SRTrilepCutBDT;
    ...
    std::function<float()> ThreeLepPreselNoNb(  Variation::ExpSyst expsyst=Variation::JES, Variation::Var var=Variation::Nominal, bool invert_btag=false);
    ...
    std::function<float()> KinSel3LNoDPhi3lMET(    Variation::ExpSyst expsyst=Variation::JES, Variation::Var var=Variation::Nominal);
    std::function<float()> KinSel3LNoMTmax(    Variation::ExpSyst expsyst=Variation::JES, Variation::Var var=Variation::Nominal);
    std::function<float()> KinSel3LNoMET(    Variation::ExpSyst expsyst=Variation::JES, Variation::Var var=Variation::Nominal);
