...
./doAnalysis -i /nfs-7/userdata/phchang/WWW_babies/WWW2017_v5.0.0/grouped/bkgdata/      -o outputs/WWW2017_v5.0.0/test1/ddfakes.root        -T t_ss -F   > outputs/WWW2017_v5.0.0/test1/ddfakes.log        2>&1 & # fake estimation
