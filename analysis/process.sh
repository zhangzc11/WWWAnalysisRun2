...
(set -x ;./doAnalysis ${DOSKIM} ${SYSTEMATICS} ${CUTFLOW} ${JOBS} ${DO_USER_STUDY} -i /nfs-7/userdata/${USERNAME}/WWW_babies/${INPUT_BABY_VERSION}/${SUBDIRECTORY}/grouped/sigallwww/    -o hists/${INPUT_BABY_VERSION}/${JOB_TAG}/www.root            -T t_ss                   > hists/${INPUT_BABY_VERSION}/${JOB_TAG}/www.log            2>&1) & # Private sample generated over winter break by P.Chang
(set -x ;./doAnalysis ${DOSKIM} ${SYSTEMATICS} ${CUTFLOW} ${JOBS} ${DO_USER_STUDY} -i /nfs-7/userdata/${USERNAME}/WWW_babies/${INPUT_BABY_VERSION}/${SUBDIRECTORY}/grouped/sigallwwz/    -o hists/${INPUT_BABY_VERSION}/${JOB_TAG}/wwz.root            -T t_ss                   > hists/${INPUT_BABY_VERSION}/${JOB_TAG}/wwz.log            2>&1) & # WWZ
(set -x ;./doAnalysis ${DOSKIM} ${SYSTEMATICS} ${CUTFLOW} ${JOBS} ${DO_USER_STUDY} -i /nfs-7/userdata/${USERNAME}/WWW_babies/${INPUT_BABY_VERSION}/${SUBDIRECTORY}/grouped/sigallwzz/    -o hists/${INPUT_BABY_VERSION}/${JOB_TAG}/wzz.root            -T t_ss                   > hists/${INPUT_BABY_VERSION}/${JOB_TAG}/wzz.log            2>&1) & # WZZ
(set -x ;./doAnalysis ${DOSKIM} ${SYSTEMATICS} ${CUTFLOW} ${JOBS} ${DO_USER_STUDY} -i /nfs-7/userdata/${USERNAME}/WWW_babies/${INPUT_BABY_VERSION}/${SUBDIRECTORY}/grouped/sigallzzz/    -o hists/${INPUT_BABY_VERSION}/${JOB_TAG}/zzz.root            -T t_ss                   > hists/${INPUT_BABY_VERSION}/${JOB_TAG}/zzz.log            2>&1) & # ZZZ
(set -x ;./doAnalysis ${DOSKIM} ${SYSTEMATICS} ${CUTFLOW} ${JOBS} ${DO_USER_STUDY} -i /nfs-7/userdata/${USERNAME}/WWW_babies/${INPUT_BABY_VERSION}/${SUBDIRECTORY}/grouped/vvv/          -o hists/${INPUT_BABY_VERSION}/${JOB_TAG}/signal.root         -T t_ss                   > hists/${INPUT_BABY_VERSION}/${JOB_TAG}/signal.log         2>&1) & # The signal sample for all triboson samples
if [ -z ${DOSKIM} ]; then
