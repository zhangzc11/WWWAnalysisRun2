...
(set -x ;./doAnalysis ${DOSKIM} ${SYSTEMATICS} ${CUTFLOW} ${JOBS} ${DO_USER_STUDY} -i /nfs-7/userdata/${USERNAME}/WWW_babies/${INPUT_BABY_VERSION}/${SUBDIRECTORY}/grouped/sigwwz/       -o hists/${INPUT_BABY_VERSION}/${JOB_TAG}/wwz.root            -T t                   > hists/${INPUT_BABY_VERSION}/${JOB_TAG}/wwz.log            2>&1) & # Private sample generated over winter break by P.Chang
(set -x ;./doAnalysis ${DOSKIM} ${SYSTEMATICS} ${CUTFLOW} ${JOBS} ${DO_USER_STUDY} -i /nfs-7/userdata/${USERNAME}/WWW_babies/${INPUT_BABY_VERSION}/${SUBDIRECTORY}/grouped/sigwzz/       -o hists/${INPUT_BABY_VERSION}/${JOB_TAG}/wzz.root            -T t                   > hists/${INPUT_BABY_VERSION}/${JOB_TAG}/wzz.log            2>&1) & # Private sample generated over winter break by P.Chang
(set -x ;./doAnalysis ${DOSKIM} ${SYSTEMATICS} ${CUTFLOW} ${JOBS} ${DO_USER_STUDY} -i /nfs-7/userdata/${USERNAME}/WWW_babies/${INPUT_BABY_VERSION}/${SUBDIRECTORY}/grouped/sigzzz/       -o hists/${INPUT_BABY_VERSION}/${JOB_TAG}/zzz.root            -T t                   > hists/${INPUT_BABY_VERSION}/${JOB_TAG}/zzz.log            2>&1) & # Private sample generated over winter break by P.Chang
if [ -z ${DOSKIM} ]; then
