...
if [ -f $DIR/datacard_s1.txt ]; then
    ...
    cat $DIR/datacard_c4.txt > $DIR/.tmp.datacard_c4.txt
    cat $DIR/datacard_c5.txt > $DIR/.tmp.datacard_c5.txt
    ...
    echo "---"                               >> $DIR/.tmp.datacard_c4.txt
    echo "---"                               >> $DIR/.tmp.datacard_c5.txt

    echo "R_in_ee rateParam s1 lostlep 1.77" >> $DIR/.tmp.datacard_s1.txt
    echo "R_in_em rateParam s2 lostlep 0.84" >> $DIR/.tmp.datacard_s2.txt
    echo "R_in_mm rateParam s3 lostlep 0.99" >> $DIR/.tmp.datacard_s3.txt
    echo "R_in_ee rateParam s4 lostlep 1.77" >> $DIR/.tmp.datacard_s4.txt
    echo "R_in_em rateParam s5 lostlep 0.84" >> $DIR/.tmp.datacard_s5.txt
    echo "R_in_mm rateParam s6 lostlep 0.99" >> $DIR/.tmp.datacard_s6.txt
    # nothing to be done for 0SFOS channel $DIR/.tmp.datacard_s7.txt
    ...
    echo "R_in_ee rateParam c1 lostlep 1.77" >> $DIR/.tmp.datacard_c1.txt
    echo "R_in_em rateParam c2 lostlep 0.84" >> $DIR/.tmp.datacard_c2.txt
    echo "R_in_mm rateParam c3 lostlep 0.99" >> $DIR/.tmp.datacard_c3.txt
    echo "R_1sfos rateParam c4 lostlep 0.92" >> $DIR/.tmp.datacard_c4.txt
    echo "R_2sfos rateParam c5 lostlep 1.00" >> $DIR/.tmp.datacard_c5.txt
    ...
    combineCards.py \
        ...
        c4=$DIR/.tmp.datacard_c4.txt \
        c5=$DIR/.tmp.datacard_c5.txt \
