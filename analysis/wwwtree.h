...
// makeCMS3ClassFiles("/nfs-7/userdata/mliu/WWW_babies/Loose2018_v5.1.9/skim/www_amcatnlo_1.root", "t", "wwwtree", "taswww", "www")
...
class wwwtree {
 ...
 protected: 
  ...
  int      nLlepSS_;
  TBranch *nLlepSS_branch;
  bool     nLlepSS_isLoaded;
  int      nLlep_;
