...
test_name = 'xgb_wwwonly_vs_photon_fakes_SFOS_noBtag'
...
#signal
signalFileName =  dataDir + 'www_SFOS.root' 
...
#bkg
bkgFileName    = dataDir + 'photon_fakes_SFOS.root'
...
#                ['jet3BtagScore', 'jet3Btag', 'jet3 Btag', 100, 0, 1],
		...
		['Pt2l', 'Pt2l', '$p_T^{ll}$ (GeV)', 100, 0, 500],
                ...
                ['DPhi3lMET', 'DPhi3lMET', '$\Delta \phi(\vec{p}_T(lll), \vec{p}_{T}^{miss})$ (GeV)', 100, 0, 10.0],
